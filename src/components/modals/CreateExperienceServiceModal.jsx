...
const CreateExperienceServiceModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Enviando datos de experiencia:', serviceData);
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Crear Nueva Experiencia</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            >
              ...
              <span>{loading ? 'Creando...' : 'Crear Experiencia'}</span>
            </button>
          </div>
        </form>
      </div>
...
export default CreateExperienceServiceModal;
