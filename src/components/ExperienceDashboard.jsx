...
import { Star, LogOut, Settings, Users, Calendar } from 'lucide-react';
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-complementary-1 rounded-lg">
                  <Star className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h1 className="text-lg font-bold text-gray-900">Dashboard Experiencias</h1>
          ...
          <div className="mb-8">
            <div className="card animate-fade-in">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">Información de la Experiencia</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="card animate-slide-up">
            <div className="flex items-center">
              <div className="p-3 bg-complementary-1 bg-opacity-10 rounded-lg">
                <Star className="h-6 w-6 text-complementary-1" />
              </div>
              <div className="ml-4">
        ...
        <div className="card text-center animate-fade-in">
          <div className="py-12">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Estamos trabajando en nuevas funcionalidades para tu dashboard de experiencias. 
              Pronto podrás gestionar tours, actividades, reservas y mucho más.
            </p>
            <div className="mt-6">
