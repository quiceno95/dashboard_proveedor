...
import { UtensilsCrossed, LogOut, Settings, Users, Calendar } from 'lucide-react';
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <div className="p-2 bg-complementary-2 rounded-lg">
                  <UtensilsCrossed className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h1 className="text-lg font-bold text-gray-900">Dashboard Restaurante</h1>
          ...
          <div className="mb-8">
            <div className="card animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.entries(restaurantData).map(([key, value]) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="card animate-slide-up">
            <div className="flex items-center">
              <div className="p-3 bg-complementary-2 bg-opacity-10 rounded-lg">
                <UtensilsCrossed className="h-6 w-6 text-complementary-2" />
              </div>
              <div className="ml-4">
          ...
          <div className="card animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Menús</p>
                <p className="text-2xl font-bold text-gray-900">--</p>
              </div>
            </div>
          </div>
        ...
        <div className="card text-center animate-fade-in">
          <div className="py-12">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Estamos trabajando en nuevas funcionalidades para tu dashboard de restaurante. 
              Pronto podrás gestionar reservas, menús, mesas y mucho más.
            </p>
            <div className="mt-6">
